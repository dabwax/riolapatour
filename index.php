...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 text-right">
                    <img src="img/mascote.png" class="mascote animated bounceInUp pull-right img-responsive" alt="">
                </div>
    ...
    <section class="secao" data-scroll-index="1" id="passeios">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img src="img/cristo.jpg" class="img-cristo wow swing" alt="Cristo Redentor">
            ...
            <div class="row row-passeios">
                <div class="col-md-4">
                    <div class="item-passeio wow bounceInLeft">
                        <a href="#">
                            <img src="http://demo.virtuti.info/demonstrations/vt15/wp-content/uploads/2014/09/timna.jpg" alt="" class="img-passeio img-responsive">
                            <h2 class="titulo-passeio">Copacabana Beach</h2>
                            <p class="descricao-passeio"><span>2 Dias</span> Tour</p>
        ...
        <div class="container">
            <div class="row" data-scroll-index="2">
                ...
                <div class="col-md-4 delay2 text-center wow bounceInLeft">
                    <img src="img/lapa2.jpg" data-wow-delay="1.70s" alt="">
                </div>
            </div>
        </div>
